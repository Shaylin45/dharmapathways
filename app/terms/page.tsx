    ...
    <div className="page-section active" data-page="terms">
      ...
      <section>
        <div className="container container-narrow">
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>2. No guarantee of admission, funding or employment</h3>
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>3. Cost and affordability estimates</h3>
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>4. Career and labour-market information</h3>
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>5. Independence policy</h3>
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>6. User responsibility</h3>
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>7. Corrections and updates</h3>
          <p>
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>8. Intellectual property</h3>
          ...
          <h3 style={{ marginTop: 'var(--space-12)' }}>9. Contact</h3>
          <p>
